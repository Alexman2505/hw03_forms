...
class PostURLTests(TestCase):
    ...
    def test_post_edit_url_redirect_guest_on_login(self):
        ...
        response = self.guest_client.get(f'/posts/{PostURLTests.post.pk}/edit/', follow=True)
        self.assertRedirects(response, f'/auth/login/?next=/posts/{PostURLTests.post.pk}/edit/')
    ...
    def test_post_edit_url_redirect_authorized_on_post_detail(self):
        ...
        response = self.authorized_client.get(f'/posts/{PostURLTests.post.pk}/edit/', follow=True)
    ...
    def test_post_edit_url_exist_on_authorized(self):
        ...
        response = self.author_client.get(f'/posts/{PostURLTests.post.pk}/edit/')
        self.assertEqual(response.status_code, HTTPStatus.OK)
